...
public class Cloth extends AppCompatActivity {
    ...
    private ExampleAdapter5 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem5> filteredList = new ArrayList<>();

        for (ExampleItem5 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        ...
        mAdapter2 = new ExampleAdapter5(nExampleList);
