...
public class Jewel extends AppCompatActivity {
    private ArrayList<ExampleItem9> nExampleList;

    private RecyclerView mRecyclerView;
    private ExampleAdapter9 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem9> filteredList = new ArrayList<>();

        for (ExampleItem9 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView9);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter9(nExampleList);
