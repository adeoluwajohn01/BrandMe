...
public class Makeup extends AppCompatActivity {
    ...
    private ExampleAdapter10 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem10> filteredList = new ArrayList<>();

        for (ExampleItem10 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        ...
        mAdapter2 = new ExampleAdapter10(nExampleList);
