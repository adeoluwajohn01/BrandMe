...
public class MotorCycle extends AppCompatActivity {
    ...
    private ExampleAdapter11 mAdapter2;
    private RecyclerView.LayoutManager mLayoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_motor_cycle);
    ...
    private void filter(String text) {
        ArrayList<ExampleItem11> filteredList = new ArrayList<>();

        for (ExampleItem11 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        ...
        mAdapter2 = new ExampleAdapter11(nExampleList);
