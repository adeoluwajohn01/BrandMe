...
public class Shoe extends AppCompatActivity {

    private ArrayList<ExampleItem14> nExampleList;

    private RecyclerView mRecyclerView;
    private ExampleAdapter14 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem14> filteredList = new ArrayList<>();

        for (ExampleItem14 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView14);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter14(nExampleList);
