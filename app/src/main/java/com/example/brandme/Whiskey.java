...
public class Whiskey extends AppCompatActivity {
    ...
    private ExampleAdapter16 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem16> filteredList = new ArrayList<>();

        for (ExampleItem16 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView16);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter16(nExampleList);
