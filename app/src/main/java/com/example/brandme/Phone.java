...
public class Phone extends AppCompatActivity {
    ...
    private ExampleAdapter13 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem13> filteredList = new ArrayList<>();

        for (ExampleItem13 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView13);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter13(nExampleList);
