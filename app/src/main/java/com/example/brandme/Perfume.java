...
public class Perfume extends AppCompatActivity {
    ...
    private ExampleAdapter12 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem12> filteredList = new ArrayList<>();

        for (ExampleItem12 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView12);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter12(nExampleList);
