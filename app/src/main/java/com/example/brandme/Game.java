...
public class Game extends AppCompatActivity {
    ...
    private ExampleAdapter8 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem8> filteredList = new ArrayList<>();

        for (ExampleItem8 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView8);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter8(nExampleList);
