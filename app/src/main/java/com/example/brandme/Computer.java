...
public class Computer extends AppCompatActivity {
    ...
    private ExampleAdapter6 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem6> filteredList = new ArrayList<>();

        for (ExampleItem6 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        ...
        mAdapter2 = new ExampleAdapter6(nExampleList);
