...
public class ExampleAdapter4 extends RecyclerView.Adapter<ExampleAdapter4.ExampleViewHolder> {
    ...
    public static class ExampleViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExampleViewHolder(View itemView) {
            ...
            mTextView1 = itemView.findViewById(R.id.textView10);
            mTextView2 = itemView.findViewById(R.id.textView11);
            mTextView3 = itemView.findViewById(R.id.textView12);
        }
    ...
    public ExampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item4,
                parent, false);
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ExampleItem4 currentItem = nExampleList.get(position);
    ...
    public void filterList2(ArrayList<ExampleItem4> filteredList) {
