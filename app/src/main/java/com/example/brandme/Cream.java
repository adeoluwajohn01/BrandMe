...
public class Cream extends AppCompatActivity {
    ...
    private ExampleAdapter7 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem7> filteredList = new ArrayList<>();

        for (ExampleItem7 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView7);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter7(nExampleList);
