...
public class Waist extends AppCompatActivity {
    ...
    private ExampleAdapter15 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem15> filteredList = new ArrayList<>();

        for (ExampleItem15 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView15);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter15(nExampleList);
