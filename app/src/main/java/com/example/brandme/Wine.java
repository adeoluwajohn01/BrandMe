...
public class Wine extends AppCompatActivity {
    ...
    private ExampleAdapter18 mAdapter2;
    ...
    private void filter(String text) {
        ArrayList<ExampleItem18> filteredList = new ArrayList<>();

        for (ExampleItem18 item : nExampleList) {
    ...
    private void buildRecyclerView() {
        mRecyclerView = findViewById(R.id.recyclerView18);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(this);
        mAdapter2 = new ExampleAdapter18(nExampleList);
